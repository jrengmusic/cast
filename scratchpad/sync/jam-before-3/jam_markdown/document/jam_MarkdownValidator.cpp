...
MarkdownValidator::matches (const MarkdownDocument& model, const juce::String& column, const juce::String& args)
{
    ...
    return forEachCell (model, column,
        [&pattern, &column] (const Element& table, const Element& row, const juce::String& value) -> juce::Result
        {
...
MarkdownValidator::existsIn (const MarkdownDocument& model, const juce::String& column, const juce::String& args)
{
    ...
    return forEachCell (model, column,
        [&targetKeys, &column, &args] (const Element& table, const Element& row, const juce::String& value) -> juce::Result
        {
...
MarkdownValidator::oneOf (const MarkdownDocument& model, const juce::String& column, const juce::String& args)
{
    ...
    return forEachCell (model, column,
        [&choices, &column] (const Element& table, const Element& row, const juce::String& value) -> juce::Result
        {
...
{
    return forEachCell (model, column,
        [&model, &column] (const Element& table, const Element& row, const juce::String& value) -> juce::Result
        {
...
MarkdownValidator::onePerGroup (const MarkdownDocument& model, const juce::String& column, const juce::String& args)
{
    ...
    for (auto* table : model.getTables())
            ...
            and model.getTableHeaders (*table).contains (args))
        {
            ...
            jam::Array<const Element*> firstRows;
...
juce::String MarkdownValidator::getLocation (const Element& table, const Element& row, const juce::String& column)
{
    juce::String path;
    juce::String line;
