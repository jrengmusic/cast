...
struct MarkdownValidator : Document::Validator
{
     ...
     * and is returned.
     *
     * @tparam Function  Callable taking (const Element& table, const Element& row, const juce::String& value), returning juce::Result.
     ...
     */
    static juce::String getLocation (const Element& table, const Element& row, const juce::String& column);
