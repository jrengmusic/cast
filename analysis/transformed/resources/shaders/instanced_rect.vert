// Vertex stage for StagePair::instancedRect and StagePair::background —
// instanced.vert minus vTextureIndex. Their fragment stages (fill_rect.frag,
// background.frag) never sample a texture; every other instanced stage pair
// uses instanced.vert instead, whose vTextureIndex output their
// bindless-sampled fragment stages consume.
#version 450
