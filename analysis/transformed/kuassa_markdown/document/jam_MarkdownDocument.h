...
struct MarkdownDocument : Document
{
     ...
     * root sentinel childless -- callers test `document.root->firstChild` to
     * detect that case.
     *
     ...
     */
    jam::Array<Element*> getTables() const;
     ...
     */
    jam::Array<Element*> getTables (const juce::Identifier& tableId) const;
     ...
     */
    jam::Array<Element*> getTableRows (Element& table) const;
     ...
     */
    jam::Array<juce::String> getTableHeaders (Element& table) const;
     ...
     */
    Element* getTableRow (Element& table, const juce::Identifier& rowId) const;
     ...
     */
    Element* getTableCell (Element& table,
     ...
     */
    juce::String getTableValue (Element& table,
                                const juce::Identifier& colId,
                                const juce::Identifier& rowId) const;
     ...
     */
    Element* getTableCell (Element& row, const juce::Identifier& colId) const;
     ...
     * @return getTableCell()'s subtext, or an empty string if the cell is not found.
     */
    juce::String getTableValue (Element& row, const juce::Identifier& colId) const;
     ...
     */
    std::string_view getTableValueView (Element& row, const juce::Identifier& colId) const;
     ...
     */
    Element* getTableList (Element& row, const juce::Identifier& colId) const;
     ...
     */
    std::string_view getTableValueView (Element& row,
                                        const juce::Identifier& colId,
     ...
     */
    bool hasTableValue (Element& row, const juce::Identifier& colId) const noexcept;
     ...
     */
    jam::Array<Element*> getTableRows (const juce::Identifier& tableId) const;
     ...
     */
    Element* getTableCell (const juce::Identifier& tableId,
                           const juce::Identifier& colId,
                           const juce::Identifier& rowId) const;
     ...
     */
    Element* getTableRow (const juce::Identifier& tableId, const juce::Identifier& rowId) const;
     ...
     */
    Element* getCodeBlock (const juce::Identifier& codeId) const noexcept;
     ...
     */
    Element* getBlockquote (Element& scope) const noexcept;
     ...
     */
    Element* getList (Element& scope) const noexcept;
     ...
     */
    Element* getListItem (Element& list, const juce::Identifier& itemId) const noexcept;
...
protected:
     ...
     */
    Element* getTable (const juce::Identifier& tableId) const noexcept;
     ...
     */
    static Element* getTableHeaderRow (const Element& table) noexcept;
...
private:
    ...
    private:
        ...
        int getListItemLeadWidth (size_t contentStart,
                                  size_t end,
                                  int markerWidth,
                                  bool ordered,
                                  int orderedValue,
        ...
        using HtmlBlockCondition = bool (*) (const std::string&, size_t, size_t);

        static constexpr jam::LookupTable<int, HtmlBlockCondition, map::HtmlBlockType::anyTag + 1>
            htmlBlockConditions {
                {
                  { map::HtmlBlockType::none, nullptr },
                  { map::HtmlBlockType::rawText, isHtmlBlockType1Start },
                  { map::HtmlBlockType::comment, isHtmlBlockType2Start },
                  { map::HtmlBlockType::processingInstruction, isHtmlBlockType3Start },
                  { map::HtmlBlockType::declaration, isHtmlBlockType4Start },
                  { map::HtmlBlockType::cdata, isHtmlBlockType5Start },
                  { map::HtmlBlockType::blockTag, isHtmlBlockType6Start },
                  { map::HtmlBlockType::anyTag, isHtmlBlockType7Start },
                  }
        };
