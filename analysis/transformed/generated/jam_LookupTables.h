 ...
 */
inline constexpr jam::LookupTable<int, uint32_t, 256> terminalColourSpace {
    {
        { 0, 0xff000000 },
        { 1, 0xffcd0000 },
        { 2, 0xff00cd00 },
 ...
 */
inline constexpr jam::LookupTable<int, juce::juce_wchar, CssTokenType::closeBrace + 1> cssCodePoints {
    {
 ...
 */
inline constexpr jam::LookupTable<int, const char*, HtmlBlockType::cdata + 1> markupOpen {
    {
 ...
 */
inline constexpr jam::LookupTable<int, const char*, HtmlBlockType::cdata + 1> markupClose {
    {
        { HtmlBlockType::none, nullptr },
 ...
 */
inline constexpr jam::LookupTable<int, const char*, HtmlType1Tag::style + 1> rawTextEnd {
    {
 ...
 */
inline constexpr jam::LookupTable<int, int, 256> markupLanguage {
    {
        { 0x0, map::Byte::text },
 ...
 */
inline constexpr jam::LookupTable<int, int, 256> css {
    {
        { 0x0, map::Byte::text },
        { 0x3c, map::Byte::operators },
        { 0x3e, map::Byte::operators },
 ...
 */
inline constexpr jam::LookupTable<int, int, 256> markdown {
    {
        { 0x0, map::Byte::text },
        { 0x3c, map::Byte::operators },
        { 0x3e, map::Byte::operators },
 ...
 * the quote bytes are quotes, and everything else defaults to text.
 */
inline constexpr jam::LookupTable<int, int, 256> code {
    {
        { 0x0, map::Byte::text },
        { 0x3c, map::Byte::operators },
        { 0x3e, map::Byte::operators },
 ...
 */
inline constexpr jam::LookupTable<int, int, 256> markup {
    {
        { 0x0, map::Byte::text },
        { 0x3c, map::Byte::operators },
        { 0x3e, map::Byte::operators },
 ...
 * text.
 */
inline constexpr jam::LookupTable<int, int, 256> data {
    {
        { 0x0, map::Byte::text },
        { 0x7b, map::Byte::operators },
        { 0x7d, map::Byte::operators },
