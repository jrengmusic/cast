...
struct Diagnostics
{
    ...
    static constexpr const char* const failSyncAmbiguity      { "identity source value maps to more than one target" };///< Two identity rows share a source value but name different target values.
