 ...
 */
    ...
    static constexpr const char* const projectName      { "cast"                                             };///< Codegen Annotated Source of Truth
    ...
    static constexpr const char* const presetExtension  { "cast"                                             };///< Preset file extension, without the leading dot.
