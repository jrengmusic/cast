...
+--------------------------------------------+-------------------------+-----------------------------------------------+--------------+------------------+
| > - list: @project-info:project info       |                         | @code:namespace                               | @ProjectInfo | @headers:headers |
|                                            |                         | - macro: #pragma once                         |              |                  |
|                                            |                         | - name: ProjectInfo                           |              |                  |
|                                            |                         | > - list: @code:constant                      |              |                  |
+--------------------------------------------+-------------------------+-----------------------------------------------+--------------+------------------+
| - list: @identifiers:identifiers           |                         | @code:namespace                               | @Identifiers | @headers:headers |
|                                            |                         | - macro: #pragma once                         |              |                  |
|                                            |                         | - name: Id                                    |              |                  |
|                                            |                         | - list: @code:identifier                      |              |                  |
+--------------------------------------------+-------------------------+-----------------------------------------------+--------------+------------------+
| > - list: @text:diagnostics                |                         | @code:namespace                               | @Text        | @headers:headers |
|                                            |                         | - macro: #pragma once                         |              |                  |
|                                            |                         | - name: text                                  |              |                  |
|                                            |                         |                                               |              |                  |
|                                            |                         | @code:struct                                  |              |                  |
...
|                                            |                         | > - list: @code:char                          |              |                  |
+--------------------------------------------+-------------------------+-----------------------------------------------+--------------+------------------+
| - list: @binaryFiles:files                 |                         | @code:namespace                               | @Files       | @headers:headers |
|                                            |                         | - macro: #pragma once                         |              |                  |
|                                            |                         | - name: files                                 |              |                  |
|                                            |                         | - list: @code:identifier                      |              |                  |
+--------------------------------------------+-------------------------+-----------------------------------------------+--------------+------------------+
| > - list: @banner:banner                   | - list: @code:linebreak | @code:namespace                               | @HashMaps    | @headers:headers |
|                                            |                         | - macro: #pragma once                         |              |                  |
|                                            |                         | - name: map                                   |              |                  |
|                                            |                         |                                               |              |                  |
|                                            |                         | @code:hash-map                                |              |                  |
...
| list                     | separator | structure                       | file       | comment          |
+==========================+===========+=================================+============+==================+
| - list: @headers:headers |           | @code:struct                    | @Generated | @headers:headers |
|                          |           | - macro: #pragma once           |            |                  |
